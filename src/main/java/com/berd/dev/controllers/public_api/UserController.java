...
public class UserController {
    ...
    public ResponseEntity<List<UserDto>> getByLikeName(@RequestParam("name") String name) throws InterruptedException {
        Thread.sleep(1000);
    ...
    public ResponseEntity<List<UserDto>> sendRequest(@RequestParam("username") String userName , HttpServletRequest request) throws InterruptedException {
